const fetchSurveyPrompt = (surveyQuestions, characteristics, individuals) => {
  return `
        ...
        **Requirements:**
            ...
            - Each profile must include an index number for each individual (e.g., Profile 1, Profile 2, etc.).
            - **Format** each profile like this:
        ...
        **Summary Totals :** Generate a table summarizing the responses in Markdown, formatted as:
        ...
        **Mentions by Type**:
          Provide a detailed breakdown of preferences in Markdown, like this:
        ...
        **Summary of Trends**:
            Analyze all responses to identify trends and present them in Markdown, like this:
