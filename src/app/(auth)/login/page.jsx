            ...
            <div className="p-6 bg-white rounded-lg shadow-md shadow-zinc-100 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="mt-2">
                            <Link href="/forgot-password" className="text-[#4e8d99] text-sm">Forgot Password?</Link>
                        </div>
                    </div>
                    <button
                        type="submit"
                    ...
                    <div className="mt-4 text-center">
                        <p>Don&apos;t have an account? <Link href="/register" className="text-[#4e8d99] underline">Register</Link></p>
                    </div>
                </form>
            </div>
        </div>
