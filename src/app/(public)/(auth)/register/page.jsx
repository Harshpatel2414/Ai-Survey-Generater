                ...
                <form onSubmit={handleSubmit} className="mt-4">
                    ...
                    <div className="mb-4 flex items-center w-full">
                        <label className="flex w-full justify-center items-center text-gray-700 mb-2" htmlFor="image">
                            <div className='flex flex-col justify-center w-full items-center'>
                                ...
                                {imgError ? <span className='text-red-400 text-sm'>Upload image less than 2mb</span> : <span className='capitalize mt-1 text-sm underline text-[#4e8d99]'>{imagePreview ? "Change" : "Upload Profile"}</span>}
                            </div>
                        </label>
                        <input
                            type="file"
                    ...
                    <div className="mb-4 flex items-center">
                        ...
                        <label htmlFor="termsAccepted" className="text-sm">
                            I agree to the <Link href="/terms-and-conditions" className="text-[#4e8d99] underline">Terms and Conditions</Link>
                        </label>
                    </div>
